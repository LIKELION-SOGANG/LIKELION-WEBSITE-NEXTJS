...
export default function ProjectItem(props: Project) {
  return props._id ? (
    <Link
      ...
      scroll={false}
      className={`flex flex-col text-white font-figtree tablet:leading-none leading-tight mb-[60px] tablet:mb-[0px] cursor-pointer tablet:w-1/4 hover:scale-105 transition ease-in-out duration-200`}>
      <span className="text-[16px] tablet:text-[20px] font-bold  pb-[8px] truncate min-h-[30px] ">
        {props.project}
      </span>

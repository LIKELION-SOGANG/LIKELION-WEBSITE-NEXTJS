    ...
    <div>
      <div className="flex justify-end">
        <div className="w-full relative h-[1268px] m-[36px_0_150px_200px] max-tablet:ml-0 box-border flex justify-end">
          <div className="w-full  flex justify-center relative h-full bg-[url('/images/about/obj2.png')] bg-lightgray bg-center bg-cover bg-no-repeat"></div>
        </div>
      </div>
      <div className="flex justify-center">
        <div className="absolute font-pp top-[35rem] text-center italic text-[9rem] max-desktop:text-[9rem] max-tablet:text-[4.5rem]">

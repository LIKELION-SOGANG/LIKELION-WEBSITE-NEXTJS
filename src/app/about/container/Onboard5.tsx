...
export default function Onboard5() {
  return (
    <section>
      <div className="flex flex-col text-white justify-center items-center bg-black w-full h-[250vh] md:h-[160vh]">
        ...
        <img
          className="bg-black h-[80vh] lg:h-[130vh] mt-[3rem] hidden md:block"
          src="images/about/curriculumn.png"
          alt="curriculmn-pc"
        />
        <img
          className="bg-black w-[80vw] mt-[3rem] block md:hidden"
      ...
      <div className="flex flex-col text-white justify-center items-center bg-black w-full h-screen">
        ...
        <div className="text-lg mt-[3rem] text-center block md:hidden">
          매주 화요일, 금요일에 진행되는 정기 세션에서
          <br /> 다양한 기술 스택을 배우고 있습니다.
        </div>
        <div className="text-2xl mt-[3rem] text-center hidden md:block">
          매주 화요일, 금요일에 진행되는 정기 세션에서 다양한 기술 스택을 배우고
          있습니다.
        </div>
        <div className="hidden md:flex w-3/5 flex-col items-center justify-center mt-24 gap-[2rem]">
        ...
        <div className="hidden md:flex w-3/5 flex-col items-center justify-center mt-52 gap-[2rem] ">
        ...
        <div className="w-3/5 flex flex-col items-center justify-center mt-24 gap-[2rem] block md:hidden">
          <div className="flex gap-[1rem]">
